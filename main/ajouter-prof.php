        ...
        <div class="page-wrapper">
            ...
            <div class="row page-titles">
                <div class="col-md-5 align-self-center">
                    <h3 class="text-themecolor">Ajouter Professeur </h3>
                </div>
                <div class="col-md-7 align-self-center">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="gestion-profs.php">Gestion des comptes</a></li>
                        <li class="breadcrumb-item"><a href="gestion-profs.php">Professeur</a></li>
                ...
                <div class="row" id="validation">
                    <div class="col-12">
                        <div class="card wizard-content">
                            <div class="card-body">
                                <h4 class="card-title">Formulaire Professeur</h4>                                
                                <form action="actions/ajouter-prof.php" method="POST" enctype="multipart/form-data" class="validation-wizard wizard-circle">
                                    <!-- Step 1 -->
                                    ...
                                    <section>
										...
										<div class="form-group">
                                        <label>Téléphone : <span class="danger">*</span></label>
                                        <input type="text" placeholder="" data-mask="(+212)9 9999-9999" class="form-control" name='tel'>
                                        <span class="font-13 text-muted required">(+212)9 9999-9999</span> </div>
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group">
													...
													<label>Cycle :<span class="danger">*</span></label>
														<select class="select2 form-control custom-select required" name='cycle' style="width: 100%; height:36px;">
								   ...
								   <div class="col-md-6">
                                    <div class="form-group ">
									<label>Matiere :<span class="danger">*</span></label>
                                    <select class="select2 custom-select form-control required" style="width: 100%; height:36px;"  name="matiere">
